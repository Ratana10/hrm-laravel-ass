        ...
        <div class="card card-outline card-primary">
            ...
            <div class="card-body login-card-body">
                ...
                <form method="POST" action="{{ route('login_post') }}">
                    ...
                    <div class="mb-1 input-group">
                        <div class="form-floating">
                            <input id="loginEmail" type="email" name="email"
                                ...
                                placeholder=""> <label for="loginEmail">Email</label>
                        </div>
                    ...
                    <div class="mb-1 input-group">
                        <div class="form-floating">
                            <input id="loginPassword" type="password" name="password"
                                class="form-control  @error('password') is-invalid @enderror" placeholder=""> <label
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="gap-2 d-grid"> <button type="submit" class="btn btn-primary">Sign In</button>
                            </div>
                        </div> <!-- /.col -->
                    </div> <!--end::Row-->
                </form>
