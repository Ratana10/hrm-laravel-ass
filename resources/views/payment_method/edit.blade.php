...
@section('content')
    <div class="card">
        <div class="card-header">
            <h2 class="mb-0 text-primary"><i class="fa fa-users"></i> {{ __('Edit Payment Method') }}</h2>
        </div>
            ...
            <div class="card-body">
                ...
                <div class="my-5 row">
                    <div class="text-center col-4">
                        <img src="{{ $payment_method->photo ? asset($payment_method->photo) : asset('default/no_photo.avif') }}"
                            alt="" class="rounded-circle" width="200" height="200" id="photo"
                    ...
                    <div class="col-8">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="is_cash" class="form-control" id="type">
                                <option value="1" {{ $payment_method->is_cash == 1 ? 'selected' : '' }}>
                                    {{ __('Cash') }}</option>
                                <option value="0" {{ $payment_method->is_cash == 0 ? 'selected' : '' }}>
                                    {{ __('Online Payment') }}</option>
                            </select>
                        </div>
                        <div class="mb-3">
